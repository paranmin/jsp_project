		...
		<section id="detail_product">
						...
						<div id="selectedItem">
							<ul>
								<li>${pro.name }
									...
									<button class="minusNum">-</button> <span class="price">${pro.sellingPrice }원</span>
			...
			<div class="datail_board">
				...
				<div class="detail_menu">
					...
					<div class="button">
						<a
							href="${pageContext.request.contextPath}/shop/ReviewForm.do?prdno=${pro.prdNo }"><button
				...
				<div class="detail_menu">
					...
					<div class="button">
						<a
							href="${pageContext.request.contextPath}/shop/BoardQandAForm.do?prdno=${pro.prdNo }"><button
